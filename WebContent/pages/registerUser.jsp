            ...
            <div style="margin-left: 37%;">
                <form action="../UserServlet" method="post">
                    <table border="0" style="text-align: left;">
                        ...
                        <tr>
                            <td>User Name:</td>
                            <td><input name="userName" type="text" required="true"> </td>
                        </tr>
                        <tr>
                            <td>Gender:</td>
                            <td>
                        ...
                        <tr>
                            <td>Department:</td>
                            <td><input name="department" type="text" required="true"> </td>
                        </tr>
                        <tr>
                            <td>Email Id:</td>
                        ...
                        <tr>
                            <td>Password:</td>
                            <td><input id = "password1" name="password" type="password" required="true"></td>
                        </tr>
                        <tr>
                            <td>Confirm password:</td>
                            <td><input id = "password2" name="conpassword" type="password" required="true"></td>
                        </tr>
                        <tr>
                            <td style="text-align: right;"><input  type="reset"></td>
                            <td style="text-align: right;"><input type="submit" name="submit" value="Register" onclick="return matchPassword()"></td>
                        </tr>
                        <tr>
